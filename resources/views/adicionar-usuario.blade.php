                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">CADASTRAR NOVO USUÁRIO</h4>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc">Insira os dados solicitados abaixo.</p>
                                        <form name="CadastrarUsuario" id="CadastrarUsuario" method="POST"
                                        action="{{ url('register') }}">
                                            @csrf
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Nome Completo</label>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <label class="col-md-2 col-form-label">Confirme a Senha</label>
                                                <div class="col-md-4">
                                                    <input class="form-control" name="password_confirmation" type="password" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <button type="submit" class="btn btn-primary mt-5 mt-sm-0">REGISTRAR</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
