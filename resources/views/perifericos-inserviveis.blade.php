                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">PERIFÉRICOS INSERVÍVEIS</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        @include('modals.filtros-p-inserviveis')
                                        <div class="table-responsive">
                                            <table id="datatable-perifericos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{$inservivel->tipo_periferico}}</td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$inservivel->secretaria->nome}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$inservivel->setor->nome}}</h5>
                                                        </td>
                                                        <td>
                                                            <a href="{{url("perifericos/$inservivel->id")}}">
