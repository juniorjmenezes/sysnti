                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                <h5 class="font-size-14">NOTEBOOKS</h5>
                                            </div>
                                            <div class="avatar-xs">
                                                <span class="rounded-circle">
                                        ...
                                        <p class="mb-0 mt-3 text-muted">Último Patrimônio Inserido: <span class="text-primary">@isset($ult_notebook){{ $ult_notebook->patrimonio }} @endisset</span></p>
                                        <div class="media-footer mt-3">
                                            <a href="{{url('computadores-notebook')}}" class="btn btn-info btn-sm waves-effect waves-light">LISTAR</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
