                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">SCANNERS PORTÁTEIS</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Portáteis</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <p class="mb-4 text-muted text-right">TOTAL DE SCANNERS PORTÁTEIS: <span class="text-primary">{{$portateis->count()}}</span></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable-equipamentos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                @foreach ($portateis as $portatil)
                                                <tr>
                                                    <td>
                                                        <p class="mb-1 font-size-12">{{ $portatil->serie}}</p>
                                                        <h5 class="font-size-15 mb-0">{{ $portatil->patrimonio}}</h5>
                                                    </td>
                                                    <td>
                                                        <p class="mb-1 font-size-12">{{ $portatil->marca}}</p>
                                                        <h5 class="font-size-15 mb-0">{{ $portatil->modelo}}</h5>
                                                    </td>
                                                    <td>
                                                        <p class="mb-1 font-size-12">{{ $portatil->setor->nome}}</p>
                                                        <h5 class="font-size-15 mb-0">{{ $portatil->secretaria->nome}}</h5>
                                                    </td>
                                                    <td>
                                                        @php
                                                        switch ($portatil['status'])
                                                        {
                                                            case 'ATIVO':
                                                                $class = 'text-success';
                                                            break;
                                                        ...
                                                        @endphp
                                                        <i class="mdi mdi-checkbox-blank-circle @php echo $class; @endphp mr-1"></i> {{ $portatil->status}}
                                                    </td>
                                                    <td>
