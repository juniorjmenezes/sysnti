                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">ROTEADORES COM FIO</h4>
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{url('roteadores')}}">Roteadores</a></li>
                                            <li class="breadcrumb-item active">Com Fio</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="m-0 align-self-center">{{$roteadores->count()}}</h4>
                                        <p class="mb-0 mt-3 text-muted">Último Patrimônio Inserido: <span class="text-primary">@isset($ult_roteador){{$ult_roteador->patrimonio }} @endisset</span></p>
                                        <div class="media-footer mt-3">
                                            <a href="{{url('roteadores')}}" class="btn btn-secondary btn-sm waves-effect waves-light">LISTAR</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                <h5 class="font-size-14">SEM FIO</h5>
                                            </div>
                                            <div class="avatar-xs">
                                                <span class="rounded-circle">
                                                    <img style="width: 100%" src="<?= asset('assets/images/icons/sem_fio.svg'); ?>">
                                                </span>
                                            </div>
                                        </div>
                                        <h4 class="m-0 align-self-center">{{$sem_fio->count() }}</h4>
                                        <p class="mb-0 mt-3 text-muted">Último Patrimônio Inserido: <span class="text-primary">@isset($ult_sem_fio){{ $ult_sem_fio->patrimonio }} @endisset</span></p>
                                        <div class="media-footer mt-3">
                                            <a href="{{url('roteadores-sem-fio')}}" class="btn btn-info btn-sm waves-effect waves-light">LISTAR</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p class="mb-4 text-muted text-right">TOTAL DE ROTEADORES COM FIO: <span class="text-primary">{{$com_fio->count()}}</span></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable-equipamentos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    @foreach ($com_fio as $cf)
                                                    <tr>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$cf->serie}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$cf->patrimonio}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$cf->marca}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$cf->modelo}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$cf->secretaria->nome}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$cf->setor->nome}}</h5>
                                                        </td>
                                                        <td>
                                                            @php
                                                                switch ($cf['status'])
                                                            ...
                                                            @endphp
                                                            <i class="mdi mdi-checkbox-blank-circle @php echo $class; @endphp mr-1"></i> {{$cf->status}}
                                                        </td>
                                                        <td>
