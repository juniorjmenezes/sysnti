                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">OUTRAS IMPRESSORAS</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Outras Impressoras</li>
                                        </ol>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p class="mb-4 text-muted text-right">TOTAL DE OUTRAS IMPRESSORAS: <span class="text-primary">{{$outras_impressoras->count()}}</span></p>
                                            </div>
                                        </div>
                                                ...
                                                <div class="btn-group">
                                                    <div class="dropdown mt-3 mr-1 mt-sm-0">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            <a class="dropdown-item mr-5" href="{{url('impressoras')}}">TODOS<span class="badge badge-pill badge-primary float-right mt-1">{{$impressoras->count()}}</span></a>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable-equipamentos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    @foreach ($outras_impressoras as $oi)
                                                    <tr>
                                                        <td>{{$oi->tipo_impressora}}</td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$oi->serie}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$oi->patrimonio}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$oi->marca}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$oi->modelo}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$oi->secretaria->nome}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$oi->setor->nome}}</h5>
                                                        </td>
                                                        <td>
                                                            @php
                                                                switch ($oi['status'])
                                                            ...
                                                            @endphp
                                                            <i class="mdi mdi-checkbox-blank-circle @php echo $class; @endphp mr-1"></i> {{$oi->status}}
                                                        </td>
                                                        <td>
