                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">WEBCAMS</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Webcams</li>
                                        </ol>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p class="mb-4 text-muted text-right">TOTAL DE WEBCAMS: <span class="text-primary">{{$webcams->count()}}</span></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable-perifericos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    @foreach ($webcams as $wc)
                                                    <tr>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$wc->serie}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$wc->patrimonio}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$wc->marca}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$wc->modelo}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$wc->secretaria->nome}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$wc->setor->nome}}</h5>
                                                        </td>
                                                        <td>
                                                            @php
                                                                switch ($wc['status'])
                                                            ...
                                                            @endphp
                                                            <i class="mdi mdi-checkbox-blank-circle @php echo $class; @endphp mr-1"></i> {{$wc->status}}
                                                        </td>
                                                        <td>
