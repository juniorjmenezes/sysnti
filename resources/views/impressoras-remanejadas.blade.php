                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">IMPRESSORAS REMANEJADAS</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Remanejadas</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <p class="mb-4 text-muted text-right">TOTAL DE IMPRESSORAS REMANEJADAS: <span class="text-primary">{{$inserviveis->count()}}</span></p>
                                        </div>
                                    </div>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown mt-3 mr-1 mt-sm-0">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        ...
                                                        <a class="dropdown-item mr-5" href="{{url('impressoras/em-manutencao')}}">MANUTENÇÃO<span class="badge badge-pill badge-danger float-right mt-1">{{$remanejados->count()}}</span></a>
                                                    </div>
                                                </div>
                                    ...
                                    @include('modals.filtros-impressoras-remanejadas')
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        @if($inservivel->tipo_impressora == 'JATO DE TINTA')
