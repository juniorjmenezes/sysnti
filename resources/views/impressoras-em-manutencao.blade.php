                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">IMPRESSORAS EM MANUTENÇÃO</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{url('impressoras')}}">Impressoras</a></li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <p class="mb-4 text-muted text-right">TOTAL DE IMPRESSORAS EM MANUTENÇÃO: <span class="text-primary">{{$manutencao->count()}}</span></p>
                                        </div>
                                    </div>
                                            ...
                                            <div class="btn-group">
                                                <div class="dropdown mt-3 mr-1 mt-sm-0">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        <a class="dropdown-item mr-5" href="{{url('impressoras')}}">TODAS<span class="badge badge-pill badge-primary float-right mt-1">{{$impressoras->count()}}</span></a>
                                    ...
                                    @include('modals.filtros-impressoras-manutencao')
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        @if($manutencao->tipo_impressora == 'JATO DE TINTA')
                                                            <h5 class="font-size-15 mb-0">JATO DE TINTA</h5>
                                                        @elseif($manutencao->tipo_impressora == 'LASER')
                                                            <h5 class="font-size-15 mb-0">LASER</h5>
                                                        @elseif($manutencao->tipo_impressora == 'DUPLICADOR')
                                                            <h5 class="font-size-15 mb-0">DUPLICADOR</h5>
                                                        @elseif($manutencao->tipo_impressora == 'MATRICIAL')
