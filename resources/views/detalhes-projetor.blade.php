                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">DETALHES DO PROJETOR</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content p-3">
                                            <div class="tab-pane active" id="hardware" role="tabpanel">
                                                <div class="form-group row">
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">TIPO DE PROJETOR</p>
                                                        <h5 class="font-size-15 mb-0">INTEGRADO</h5>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">MARCA</p>
                                                        <h5 class="font-size-15 mb-0">PROCOMP/EPSON</h5>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">MODELO</p>
                                                        <h5 class="font-size-15 mb-0">LS-5580</h5>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <h5 class="font-size-15 mb-0">INTEL ATOM D425</h5>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">MEMÓRIA RAM</p>
                                                        <h5 class="font-size-15 mb-0">1GB DDR3</h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="suprimentos" role="tabpanel">
                                                <p class="mb-1 font-size-12">LÂMPADA</p>
                                                <h5 class="font-size-15 mb-0">ELPLP96/V13H10L96</h5>
                                            </div>
