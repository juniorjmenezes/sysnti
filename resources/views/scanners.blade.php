                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">SCANNERS</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p class="mb-4 text-muted text-right">TOTAL DE SCANNERS: <span class="text-primary">{{$scanners->count()}}</span></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable-equipamentos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{ $scanner->tipo_scanner}}</td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{ $scanner->serie}}</p>
                                                            <h5 class="font-size-15 mb-0">{{ $scanner->patrimonio}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{ $scanner->marca}}</p>
                                                            <h5 class="font-size-15 mb-0">{{ $scanner->modelo}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{ $scanner->setor->nome}}</p>
                                                            <h5 class="font-size-15 mb-0">{{ $scanner->secretaria->nome}}</h5>
                                                        </td>
                                                        <td>
                                                            @php
                                                            switch ($scanner['status'])
                                                            {
                                                             ...
                                                             @endphp
                                                            <i class="mdi mdi-checkbox-blank-circle @php echo $class; @endphp mr-1"></i> {{ $scanner->status}}
                                                        </td>
                                                        <td>
