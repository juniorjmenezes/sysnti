                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">PERIFÉRICOS REMANEJADOS</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p class="mb-4 text-muted text-right">TOTAL DE PERIFÉRICOS REMANEJADOS: <span class="text-primary">{{$remanejados->count()}}</span></p>
                                            </div>
                                        </div>
                                        ...
                                        @include('modals.filtros-p-remanejados')
                                        <div class="table-responsive">
                                            <table id="datatable-perifericos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{$remanejado->tipo_periferico}}</td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$remanejado->secretaria->nome}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$remanejado->setor->nome}}</h5>
                                                        </td>
                                                        <td>
                                                            <a href="{{url("perifericos/$remanejado->id")}}">
