                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">COMPUTADORES REMANEJADOS</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{url('computadores')}}">Computadores</a></li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <p class="mb-4 text-muted text-right">TOTAL DE COMPUTADORES REMANEJADOS: <span class="text-primary">{{$inserviveis->count()}}</span></p>
                                        </div>
                                    </div>
                                            ...
                                            <div class="btn-group">
                                                <div class="dropdown mt-3 mr-1 mt-sm-0">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        <a class="dropdown-item mr-5" href="{{url('computadores')}}">TODOS<span class="badge badge-pill badge-primary float-right mt-1">{{$computadores->count()}}</span></a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item mr-5" href="{{url('computadores/desktops')}}">DESKTOPS<span class="badge badge-pill badge-secondary float-right mt-1">{{$desktops->count()}}</span></a>
                                                        <a class="dropdown-item mr-5" href="{{url('computadores/notebooks')}}">NOTEBOOKS<span class="badge badge-pill badge-secondary float-right mt-1">{{$notebooks->count()}}</span></a>
                                                        <a class="dropdown-item mr-5" href="{{url('computadores/servidores')}}">SERVIDORES<span class="badge badge-pill badge-secondary float-right mt-1">{{$servidores->count()}}</span></a>
                                                    </div>
                                                </div>
                                                <div class="dropdown mt-3 mr-1 mt-sm-0">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        <a class="dropdown-item mr-5" href="{{url('computadores/ativos')}}">ATIVOS<span class="badge badge-pill badge-success float-right mt-1">{{$ativos->count()}}</span></a>
                                                        <a class="dropdown-item mr-5" href="{{url('computadores/inserviveis')}}">INSERVÍVEIS<span class="badge badge-pill badge-secondary float-right mt-1">{{$inserviveis->count()}}</span></a>
                                                        <a class="dropdown-item mr-5" href="{{url('computadores/em-manutencao')}}">MANUTENÇÃO<span class="badge badge-pill badge-danger float-right mt-1">{{$manutencao->count()}}</span></a>
                                                    </div>
                                                </div>
                                    ...
                                    @include('modals.filtros-computadores-remanejados')
                                    <div class="table-responsive">
                                        <table id="datatable-equipamentos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                @foreach ($remanejados as $remanejado)
                                                <tr>
                                                    <td>
                                                        <p class="mb-1 font-size-12">{{ $remanejado->tipo_equipamento}}</p>
                                                        @if($remanejado->tipo_computador == 'DESKTOP')
                                                            <h5 class="font-size-15 mb-0">DESKTOP</h5>
                                                        @elseif($remanejado->tipo_computador == 'NOTEBOOK')
                                                            <h5 class="font-size-15 mb-0">NOTEBOOK</h5>
                                                        @elseif($remanejado->tipo_computador == 'SERVIDOR')
                                                            <h5 class="font-size-15 mb-0">SERVIDOR</h5>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <p class="mb-1 font-size-12">{{ $remanejado->serie}}</p>
                                                        <h5 class="font-size-15 mb-0">{{ $remanejado->patrimonio}}</h5>
                                                    </td>
                                                    <td>
                                                        <p class="mb-1 font-size-12">{{ $remanejado->marca}}</p>
                                                        <h5 class="font-size-15 mb-0">{{ $remanejado->modelo}}</h5>
                                                    </td>
                                                    <td>
                                                        <p class="mb-1 font-size-12">{{ $remanejado->setor->nome}}</p>
                                                        <h5 class="font-size-15 mb-0">{{ $remanejado->secretaria->nome}}</h5>
                                                    </td>
                                                    <td>
