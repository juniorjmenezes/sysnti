                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">PERFIL DO USUÁRIO</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#perfil" role="tab">
                                                    ...
                                                    <span class="d-none d-md-inline-block">PERFIL</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#senha" role="tab">
                                                    <i class="ti-save mr-1 align-middle"></i>
                                                    <span class="d-none d-md-inline-block">SENHA</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#seguranca" role="tab">
                                                    <i class="ti-package mr-1 align-middle"></i>
                                                    <span class="d-none d-md-inline-block">SEGURANÇA</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#sessoes" role="tab">
                                                    <i class="ti-world mr-1 align-middle"></i>
                                                    <span class="d-none d-md-inline-block">SESSÕES</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#apagar" role="tab">
                                                    <i class="ti-settings mr-1 align-middle"></i>
                                                    <span class="d-none d-md-inline-block">APAGAR CONTA</span>
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="tab-content p-3">
                                            <div class="tab-pane active" id="perfil" role="tabpanel">
                                                <form name="EditarUsuario" id="EditarUsuario" method="POST" action="{{route('usuario-update')}}">
                                                    @method('PUT')
                                                    @csrf
                                            ...
                                            <div class="tab-pane" id="senha" role="tabpanel">
                                                <form name="EditarSenha" id="EditarSenha" method="POST" action="{{route('user-password.update')}}">
                                                    @method('PUT')
                                                    @csrf
                                                    <x-slot name="form">
                                                        <div class="col-span-6 sm:col-span-4">
                                                            <x-jet-label for="current_password" value="{{ __('Current Password') }}" />
                                                            <x-jet-input id="current_password" name="current_password" type="password" class="mt-1 block w-full" wire:model.defer="state.current_password" autocomplete="current-password" />
                                                        ...
                                                        <div class="col-span-6 sm:col-span-4">
                                                            ...
                                                            <x-jet-input id="password_confirmation" name="password" type="password" class="mt-1 block w-full" wire:model.defer="state.password_confirmation" autocomplete="new-password" />
                                            ...
                                            <div class="tab-pane" id="sessoes" role="tabpanel">

                                            </div>
                                            <div class="tab-pane" id="apagar" role="tabpanel">
                                                <p class="mb-0">
