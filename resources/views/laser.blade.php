                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">IMPRESSORAS LASER</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="media-footer mt-3">
                                            <a href="{{url('laser')}}" class="btn btn-info btn-sm waves-effect waves-light">LISTAR</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$ls->serie}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$ls->patrimonio}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$ls->marca}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$ls->modelo}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$ls->secretaria->nome}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$ls->setor->nome}}</h5>
                                                        </td>
                                                        <td>
                                                            @php
                                                                switch ($ls['status'])
                                                            ...
                                                            @endphp
                                                            <i class="mdi mdi-checkbox-blank-circle @php echo $class; @endphp mr-1"></i> {{$ls->status}}
                                                        </td>
                                                        <td>
