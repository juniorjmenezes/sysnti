                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">COMPUTADORES</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p class="mb-4 text-muted text-right">TOTAL DE COMPUTADORES: <span class="text-primary">{{$computadores->count()}}</span></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable-equipamentos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{$computador->tipo_computador}}</td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$computador->serie}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$computador->patrimonio}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$computador->marca}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$computador->modelo}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$computador->secretaria->nome}}</p>
                                                        ...
                                                        <td>
                                                            <a href="{{url("computadores/$computador->id/detalhes-computador")}}">
