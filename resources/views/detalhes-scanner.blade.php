                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">DETALHES DO SCANNER</h4>
                                            ...
                                            <div class="tab-pane active" id="alocacao" role="tabpanel">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <h5 class="font-size-15 mb-0"><i class="mdi mdi-checkbox-blank-circle text-info mr-1"></i><a href="#remanejo" data-toggle="modal" data-target="#remanejo">ATIVO/REMANEJADO</a></h5>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content p-3">
                                            <div class="tab-pane active" id="hardware" role="tabpanel">
                                                <div class="form-group row">
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">TIPO DE SCANNER</p>
                                                        <h5 class="font-size-15 mb-0">VERTICAL</h5>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">MARCA</p>
                                                        <h5 class="font-size-15 mb-0">EPSON</h5>
                                                    </div>
                                                    <div class="col-md-4">
