                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">ROTEADORES</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                <h5 class="font-size-14">COM FIO</h5>
                                            </div>
                                            <div class="avatar-xs">
                                                <span class="rounded-circle">
                                                    <img style="width: 100%" src="<?= asset('assets/images/icons/com_fio.svg'); ?>">
                                                </span>
                                            </div>
                                        </div>
                                        <h4 class="m-0 align-self-center">{{$com_fio->count() }}</h4>
                                        <p class="mb-0 mt-3 text-muted">Último Patrimônio Inserido: <span class="text-primary">@isset($ult_com_fio){{$ult_com_fio->patrimonio }} @endisset</span></p>
                                        <div class="media-footer mt-3">
                                            <a href="{{url('roteadores-com-fio')}}" class="btn btn-info btn-sm waves-effect waves-light">LISTAR</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable-equipamentos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{$roteador->tipo_impressora}}</td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$roteador->serie}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$roteador->patrimonio}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$roteador->marca}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$roteador->modelo}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$roteador->setor->nome}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$roteador->secretaria->nome}}</h5>
                                                        </td>
                                                        <td>
                                                            @php
                                                            switch ($roteador['status'])
                                                            {
                                                                case 'ATIVO':
                                                                    $class = 'text-success';
                                                                break;
                                                            ...
                                                            @endphp
                                                            <i class="mdi mdi-checkbox-blank-circle @php echo $class; @endphp mr-1"></i> {{$roteador->status}}
                                                        </td>
                                                        <td>
