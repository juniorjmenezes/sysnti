                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">COMPUTADORES EM MANUTENÇÃO</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <p class="mb-4 text-muted text-right">TOTAL DE COMPUTADORES EM MANUTENÇÃO: <span class="text-primary">{{$inserviveis->count()}}</span></p>
                                        </div>
                                    </div>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown mt-3 mr-1 mt-sm-0">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        ...
                                                        <a class="dropdown-item mr-5" href="{{url('computadores/remanejados')}}">REMANEJADOS<span class="badge badge-pill badge-primary float-right mt-1">{{$remanejados->count()}}</span></a>
                                                    </div>
                                                </div>
                                    ...
                                    @include('modals.filtros-computadores-manutencao')
                                    <div class="table-responsive">
                                        <table id="datatable-equipamentos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <p class="mb-1 font-size-12">{{ $manutencao->tipo_equipamento}}</p>
                                                        @if($manutencao->tipo_computador == 'DESKTOP')
                                                            <h5 class="font-size-15 mb-0">DESKTOP</h5>
                                                        @elseif($manutencao->tipo_computador == 'NOTEBOOK')
                                                            <h5 class="font-size-15 mb-0">NOTEBOOK</h5>
                                                        @elseif($manutencao->tipo_computador == 'SERVIDOR')
                                                            <h5 class="font-size-15 mb-0">SERVIDOR</h5>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <p class="mb-1 font-size-12">{{ $manutencao->serie}}</p>
                                                        <h5 class="font-size-15 mb-0">{{ $manutencao->patrimonio}}</h5>
                                                    </td>
                                                    <td>
                                                        <p class="mb-1 font-size-12">{{ $manutencao->marca}}</p>
                                                        <h5 class="font-size-15 mb-0">{{ $manutencao->modelo}}</h5>
                                                    </td>
                                                    <td>
                                                        <p class="mb-1 font-size-12">{{ $manutencao->setor->nome}}</p>
                                                        <h5 class="font-size-15 mb-0">{{ $manutencao->secretaria->nome}}</h5>
                                                    </td>
                                                    <td>
