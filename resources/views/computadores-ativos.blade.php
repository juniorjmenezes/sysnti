                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">COMPUTADORES ATIVOS</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <p class="mb-4 text-muted text-right">TOTAL DE COMPUTADORES ATIVOS: <span class="text-primary">{{$ativos->count()}}</span></p>
                                        </div>
                                    </div>
                                    ...
                                    @include('modals.filtros-computadores-ativos')
