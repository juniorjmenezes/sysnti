                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">DETALHES DO ROTEADOR</h4>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content p-3">
                                            <div class="tab-pane active" id="hardware" role="tabpanel">
                                                <div class="form-group row">
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">TIPO DE ROTEADOR</p>
                                                        <h5 class="font-size-15 mb-0">SEM FIO</h5>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">MARCA</p>
                                                        <h5 class="font-size-15 mb-0">INTELBRAS</h5>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">MODELO</p>
                                                        <h5 class="font-size-15 mb-0">IWR-3000N</h5>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">QUANTIDADE DE ANTENAS</p>
                                                        <h5 class="font-size-15 mb-0">2</h5>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-pane" id="rede" role="tabpanel">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">PORTA EXTERNA</p>
                                                        <h5 class="font-size-15 mb-0">8080</h5>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">SSID</p>
                                                        <h5 class="font-size-15 mb-0">NTI</h5>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">TIPO DE CRIPTOGRAFIA</p>
                                                        <h5 class="font-size-15 mb-0">WPA-2/PSK</h5>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">SENHA DA REDE</p>
                                                        <h5 class="font-size-15 mb-0">21091005</h5>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">USUÁRIO</p>
                                                        <h5 class="font-size-15 mb-0">admin</h5>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <p class="mb-1 font-size-12">SENHA</p>
                                                        <h5 class="font-size-15 mb-0">prefeitura</h5>
                                                    </div>
                                                </div>
                                            </div>
