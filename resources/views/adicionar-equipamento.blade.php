...
@include('layouts.menu')
                        ...
                        @csrf
                            ...
                            <div id="origem" class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="header-title">ORIGEM</h4>
                                            <p class="card-title-desc">Informe Secretaria e Setor de onde o equipamento foi remanejado.</p>
                                            <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Secretaria</label>
                                                <div class="col-md-4">
                                                    <div class="chosen-select-act fm-cmp-mg">
                                            ...
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-md-2 col-form-label">Data do Remanejo</label>
                                                <div class="col-md-4">
                                                ...
                                                <label for="example-text-input" class="col-md-2 col-form-label">Tipo de Remanejo</label>
                                                <div class="col-md-4">
                                                    <div class="chosen-select-act fm-cmp-mg">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <input id="cpu" class="form-control input-mask" name="cpu" type="text" value="">
                                                </div>
                                            ...
                                            <div id="hd1-hd2" class="form-group row">
                                                <label class="col-md-2 col-form-label">HD1</label>
                                                <div class="col-md-4">
                                                    <input class="form-control" name="hd1" type="text" value="">
                                                </div>
                                                <label class="col-md-2 col-form-label">HD2</label>
                                                <div class="col-md-4">
                                                    <input class="form-control" name="hd2" type="text" value="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script src="<?= asset('assets/js/pages/adicionar-equipamento/scripts.js'); ?>"></script>
    </body>
