                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">MONITORES</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p class="mb-4 text-muted text-right">TOTAL DE MONITORES: <span class="text-primary">{{$monitores->count()}}</span></p>
                                            </div>
                                        </div>
                                            ...
                                            <table id="datatable-perifericos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$mt->secretaria->nome}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$mt->setor->nome}}</h5>
                                                        </td>
                                                        <td>
                                                            @php
                                                                switch ($mt['status'])
                                                            ...
                                                            @endphp
                                                            <i class="mdi mdi-checkbox-blank-circle @php echo $class; @endphp mr-1"></i> {{$mt->status}}
                                                        </td>
                                                        <td>
