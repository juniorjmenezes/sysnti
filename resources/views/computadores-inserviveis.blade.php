                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">COMPUTADORES INSERVÍVEIS</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Inservíveis</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <p class="mb-4 text-muted text-right">TOTAL DE COMPUTADORES INSERVÍVEIS: <span class="text-primary">{{$inserviveis->count()}}</span></p>
                                        </div>
                                    </div>
                                    ...
                                    @include('modals.filtros-computadores-inserviveis')
