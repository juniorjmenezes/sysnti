                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">PROJETORES</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Projetores</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                <h5 class="font-size-14">INTEGRADOS</h5>
                                            </div>
                                            <div class="avatar-xs">
                                                <span class="rounded-circle">
                                                    <img style="width: 100%" src="<?= asset('assets/images/icons/projetor_integrado.svg'); ?>">
                                                </span>
                                            </div>
                                        </div>
                                        <h4 class="m-0 align-self-center">{{$integrados->count() }}</h4>
                                        <p class="mb-0 mt-3 text-muted">Último Patrimônio Inserido: <span class="text-primary">@isset($ult_integrado){{$ult_integrado->patrimonio }} @endisset</span></p>
                                        <div class="media-footer mt-3">
                                            <a href="{{url('projetores-integrados')}}" class="btn btn-info btn-sm waves-effect waves-light">LISTAR</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p class="mb-4 text-muted text-right">TOTAL DE PROJETORES: <span class="text-primary">{{$projetores->count()}}</span></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable-equipamentos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{$projetor->tipo_projetor}}</td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$projetor->serie}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$projetor->patrimonio}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$projetor->marca}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$projetor->modelo}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$projetor->setor->nome}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$projetor->secretaria->nome}}</h5>
                                                        </td>
                                                        <td>
                                                            @php
                                                            switch ($projetor['status'])
                                                            {
                                                                case 'ATIVO':
                                                                    $class = 'text-success';
                                                                break;
                                                            ...
                                                            @endphp
                                                            <i class="mdi mdi-checkbox-blank-circle @php echo $class; @endphp mr-1"></i> {{$projetor->status}}
                                                        </td>
                                                        <td>
