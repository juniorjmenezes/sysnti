        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    <strong>Atenção!</strong> Antes de prosseguir, detalhe o Periférico Inservível a ser cadastrado.
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" name="mais_detalhes" rows="2"></textarea>
                    </div>
                </div>
            </div>
