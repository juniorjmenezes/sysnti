                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">IMPRESSORAS</h4>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{ $impressora->serie }}</p>
                                                            <h5 class="font-size-15 mb-0">{{ $impressora->patrimonio }}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{ $impressora->marca }}</p>
                                                            <h5 class="font-size-15 mb-0">{{ $impressora->modelo }}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{ $impressora->setor->nome }}</p>
                                                            <h5 class="font-size-15 mb-0">{{ $impressora->secretaria->nome }}</h5>
                                                        </td>
                                                        <td>
                                                            @php
                                                            ...
                                                            @endphp
                                                            <i class="mdi mdi-checkbox-blank-circle @php echo $class; @endphp mr-1"></i> {{ $impressora->status }}
                                                        </td>
                                                        <td>
