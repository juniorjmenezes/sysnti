                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">IMPRESSORAS JATO DE TINTA</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Jato de Tinta</li>
                                        </ol>
                                    </div>
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="m-0 align-self-center">{{ $impressoras->count()}}</h4>
                                        <p class="mb-0 mt-3 text-muted">Último Patrimônio Inserido: <span class="text-primary">@isset($ult_impressora){{ $ult_impressora->patrimonio }} @endisset</span></p>
                                        <div class="media-footer mt-3">
                                            <a href="{{url('impressoras')}}" class="btn btn-secondary btn-sm waves-effect waves-light">LISTAR</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title mb-4">LISTAGEM DE EQUIPAMENTOS</h4>
                                        <div class="table-responsive">
                                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    @foreach ($jato_tinta as $jt)
                                                    <tr>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$jt->serie}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$jt->patrimonio}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$jt->marca}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$jt->modelo}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$jt->secretaria->nome}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$jt->setor->nome}}</h5>
                                                        </td>
                                                        <td>
                                                            @php
                                                                switch ($jt['status'])
                                                            ...
                                                            @endphp
                                                            <i class="mdi mdi-checkbox-blank-circle @php echo $class; @endphp mr-1"></i> {{$jt->status}}
                                                        </td>
                                                        <td>
