                                    ...
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                <h5 class="font-size-14">DESKTOPS</h5>
                                            </div>
                                            <div class="avatar-xs">
                                                <span class="rounded-circle">
                                                    <img style="width: 100%" src="<?= asset('assets/images/icons/notebook.svg'); ?>">
                                                </span>
                                            </div>
                                        </div>
                                        <h4 class="m-0 align-self-center">{{ $notebooks->count()}}</h4>
                                        <p class="mb-0 mt-3 text-muted">Último Patrimônio Inserido: <span class="text-primary">@isset($ult_desktop){{ $ult_desktop->patrimonio }} @endisset</span></p>
                                        <div class="media-footer mt-3">
                                            <a href="{{url('computadores-desktop')}}" class="btn btn-info btn-sm waves-effect waves-light">LISTAR</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="m-0 align-self-center">{{ $computadores->count()}}</h4>
                                        <p class="mb-0 mt-3 text-muted">Último Patrimônio Inserido: <span class="text-primary">@isset($ult_computador){{ $ult_computador->patrimonio }} @endisset</span></p>
                                        <div class="media-footer mt-3">
                                            <a href="{{url('computadores')}}" class="btn btn-secondary btn-sm waves-effect waves-light">LISTAR</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xl-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="media">
                                            <div class="media-body">
                                                <h5 class="font-size-14">SERVIDORES</h5>
                                            </div>
                                            <div class="avatar-xs">
                                                <span class="rounded-circle">
                                                    <img style="width: 100%" src="<?= asset('assets/images/icons/servidor.svg'); ?>">
                                                </span>
                                            </div>
                                        </div>
                                        <h4 class="m-0 align-self-center">{{ $servidores->count()}}</h4>
                                        <p class="mb-0 mt-3 text-muted">Último Patrimônio Inserido: <span class="text-primary">@isset($ult_servidor){{ $ult_servidor->patrimonio }} @endisset</span></p>
                                        <div class="media-footer mt-3">
                                            <a href="{{url('computadores-servidor')}}" class="btn btn-info btn-sm waves-effect waves-light">LISTAR</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
