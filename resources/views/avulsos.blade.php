                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0 font-size-18">PROJETORES AVULSO</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Avulso</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p class="mb-4 text-muted text-right">TOTAL DE PROJETORES AVULSO: <span class="text-primary">{{$avulsos->count()}}</span></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table id="datatable-equipamentos" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$avulso->serie}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$avulso->patrimonio}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$avulso->marca}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$avulso->modelo}}</h5>
                                                        </td>
                                                        <td>
                                                            <p class="mb-1 font-size-12">{{$avulso->setor->nome}}</p>
                                                            <h5 class="font-size-15 mb-0">{{$avulso->secretaria->nome}}</h5>
                                                        </td>
                                                        <td>
                                                            @php
                                                            switch ($avulso['status'])
                                                            {
                                                                case 'ATIVO':
                                                                    $class = 'text-success';
                                                                break;
                                                            ...
                                                            @endphp
                                                            <i class="mdi mdi-checkbox-blank-circle @php echo $class; @endphp mr-1"></i> {{$avulso->status}}
                                                        </td>
                                                        <td>
